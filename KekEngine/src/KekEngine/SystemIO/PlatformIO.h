...
namespace Kek
{
	...
	{
		extern void Init();
		extern FunctionPointer<bool, int, int, int> keyCallback;
		extern FunctionPointer<bool, vec2i> mouseMoveCallback;
		extern FunctionPointer<bool, vec2i> scrollWheelCallback;
